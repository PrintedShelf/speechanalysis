...
pathy = '/Users/printedshelf/Downloads/Speechat-master'
name = 'Rishabh 1'
t0 = 5
levvel=50
...
with sf.SoundFile(rere, mode='x', samplerate=samplerate, channels=1) as file:
    with sd.InputStream(samplerate=samplerate, device=0, channels=1, callback=data_callback,blocksize=20500):
